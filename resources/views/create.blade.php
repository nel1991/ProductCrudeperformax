...
<div class="container prodarea">
      ...
      <div class="container">
        ...
        <form action="{{ url('prod') }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}  




<label>Create Product and Assign Product Categories</label>
<div class="row">
  <div class="col">

    
    <input type="number" class="form-control" placeholder="Product ID No" name="id">
  </div> 
  <div class="col">
...
<!-- 
      ...
      <input type="submit" value="Save" class="btn btn-success" style="margin-top: 10px;margin-bottom: 10px;"></br>
